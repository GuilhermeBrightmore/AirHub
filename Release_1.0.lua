...
TextLabel_2.Parent = Lines
TextLabel_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_2.BackgroundTransparency = 1.000
TextLabel_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel_2.BorderSizePixel = 0
TextLabel_2.Position = UDim2.new(-0.0246153846, 0, 0, 0)
TextLabel_2.Size = UDim2.new(0, 154, 0, 33)
TextLabel_2.Font = Enum.Font.FredokaOne
TextLabel_2.Text = "Lines"
...
TextLabel_4.Parent = HeadESP
TextLabel_4.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_4.BackgroundTransparency = 1.000
TextLabel_4.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel_4.BorderSizePixel = 0
TextLabel_4.Position = UDim2.new(0.0184615385, 0, 0, 0)
TextLabel_4.Size = UDim2.new(0, 154, 0, 33)
TextLabel_4.Font = Enum.Font.FredokaOne
TextLabel_4.Text = "Head ESP"
...
TextLabel_5.Parent = Aimbot
TextLabel_5.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_5.BackgroundTransparency = 1.000
TextLabel_5.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel_5.BorderSizePixel = 0
TextLabel_5.Position = UDim2.new(-0.0276923068, 0, 0, 0)
...
TextLabel_6.Parent = TeamCheck
TextLabel_6.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_6.BackgroundTransparency = 1.000
TextLabel_6.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel_6.BorderSizePixel = 0
TextLabel_6.Position = UDim2.new(0.0276923068, 0, 0, 0)
TextLabel_6.Size = UDim2.new(0, 154, 0, 33)
TextLabel_6.Font = Enum.Font.FredokaOne
TextLabel_6.Text = "TeamCheck"
TextLabel_6.TextColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_6.TextSize = 19.000

Toogle_2.Name = "Toogle"
Toogle_2.Parent = TeamCheck
...
UICorner_16.Parent = Off_2

TextLabel_7.Parent = Toogle_2
TextLabel_7.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_7.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel_7.BorderSizePixel = 0
TextLabel_7.Position = UDim2.new(5.93023252, 0, -1.0625, 0)
...
UICorner_20.Parent = Off_3

TextLabel_9.Parent = Toogle_3
...
UICorner_24.Parent = Off_4

TextLabel_11.Parent = Toogle_4
...
UICorner_28.Parent = Off_5

TextLabel_13.Parent = Toogle_5
...
UICorner_31.Parent = fill

UICorner_32.Parent = Slider
...
TextLabel_15.Parent = Safe
TextLabel_15.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_15.BackgroundTransparency = 1.000
TextLabel_15.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel_15.BorderSizePixel = 0
TextLabel_15.Position = UDim2.new(-0.0246153846, 0, 0, 0)
TextLabel_15.Size = UDim2.new(0, 154, 0, 33)
TextLabel_15.Font = Enum.Font.FredokaOne
TextLabel_15.Text = "GotoSafe"
...
UICorner_34.Parent = Abrir

-- Scripts:

local function XHCMVP_fake_script() -- Main.LocalScript 
...
coroutine.wrap(XHCMVP_fake_script)()
local function ODCU_fake_script() -- Main_3.LocalScript 
...
coroutine.wrap(ODCU_fake_script)()
local function AVLN_fake_script() -- PrisionLife.LocalScript 
...
coroutine.wrap(AVLN_fake_script)()
local function BFYJ_fake_script() -- Misc.LocalScript 
...
coroutine.wrap(BFYJ_fake_script)()
local function YXPX_fake_script() -- Fechar.LocalScript 
...
coroutine.wrap(YXPX_fake_script)()
local function VTYRU_fake_script() -- Min.LocalScript 
...
coroutine.wrap(VTYRU_fake_script)()
local function BZUO_fake_script() -- Nome.MainScript 
...
coroutine.wrap(BZUO_fake_script)()
local function IJMOS_fake_script() -- Name.LocalScript 
...
coroutine.wrap(IJMOS_fake_script)()
local function LWOA_fake_script() -- Lines.LocalScript 
...
coroutine.wrap(LWOA_fake_script)()
local function VRYNVZ_fake_script() -- Box.LocalScript 
	...
	function box()
		if toogleesp then
			...
			game.Players.PlayerRemoving:Connect(function(player)
				if playerOutlines[player] then
					playerOutlines[player]:Destroy()
					playerOutlines[player] = nil
				end
			end)
		else
			-- Remover ESP de todos os jogadores
			for player, outline in pairs(playerOutlines) do
				if outline and outline:IsA("BillboardGui") then
					outline:Destroy()
				end
			end
			playerOutlines = {}  -- Limpar a tabela de contornos
		end
	end
	...
	function addHeadOutline(player)
		...
		outline.StudsOffset = Vector3.new(0, 0, 0)
		outline.Parent = head
	...
	script.Parent.Activated:Connect(function()
		toogleesp = not toogleesp  -- Inverte o estado do toogleesp
		box()  -- Chama a função principal para atualizar o ESP
	end)
	
end
coroutine.wrap(VRYNVZ_fake_script)()
local function TPTJ_fake_script() -- HeadESP.LocalScript 
...
coroutine.wrap(TPTJ_fake_script)()
local function TGSECHV_fake_script() -- Aimbot.LocalScript 
	...
	local function toggleAimbot()
		if aimbotEnabled.Text == 'on' then
			...
			if game:GetService("RunService"):IsClient() then
				...
				fovFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Cor inicial (vermelho)
				...
				game:GetService("RunService").RenderStepped:Connect(function()
					...
					-- Atualizar a cor do FOV para vermelho (opcional, apenas se necessário)
					fovFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Garantir que o FOV seja vermelho
				end)
			end
		end
	end
...
coroutine.wrap(TGSECHV_fake_script)()
local function MNCXAD_fake_script() -- TeamCheck.ToogleScript 
...
coroutine.wrap(MNCXAD_fake_script)()
local function XOYCR_fake_script() -- TriggerBot.ToogleScript 
...
coroutine.wrap(XOYCR_fake_script)()
local function KKLTFQ_fake_script() -- WallCheck.ToogleScript 
...
coroutine.wrap(KKLTFQ_fake_script)()
local function PWODS_fake_script() -- Fov.ToogleScript 
...
coroutine.wrap(PWODS_fake_script)()
local function PDLAVRN_fake_script() -- Slider.LocalScript 
...
coroutine.wrap(PDLAVRN_fake_script)()
local function CPXEP_fake_script() -- Safe.LocalScript 
...
coroutine.wrap(CPXEP_fake_script)()
local function UZXW_fake_script() -- Abrir.LocalScript 
...
coroutine.wrap(UZXW_fake_script)()
