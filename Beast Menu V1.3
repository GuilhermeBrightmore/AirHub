...
UICorner_50.Parent = Discord

TextLabel_22.Parent = Discord
TextLabel_22.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel_22.BackgroundTransparency = 1.000
TextLabel_22.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel_22.BorderSizePixel = 0
TextLabel_22.Position = UDim2.new(0.611111104, 0, -0.222222224, 0)
TextLabel_22.Size = UDim2.new(0, 98, 0, 26)
TextLabel_22.Font = Enum.Font.FredokaOne
TextLabel_22.Text = "Beast Scripts"
...
UICorner_51.Parent = Abrir

-- Scripts:

local function OCTUY_fake_script() -- Main_3.LocalScript 
...
coroutine.wrap(OCTUY_fake_script)()
local function KCVOHA_fake_script() -- PrisionLife.LocalScript 
...
coroutine.wrap(KCVOHA_fake_script)()
local function SJXHS_fake_script() -- Misc.LocalScript 
...
coroutine.wrap(SJXHS_fake_script)()
local function VJDC_fake_script() -- Fechar.LocalScript 
...
coroutine.wrap(VJDC_fake_script)()
local function GTURK_fake_script() -- Min.LocalScript 
...
coroutine.wrap(GTURK_fake_script)()
local function HUBYBP_fake_script() -- Nome.MainScript 
...
coroutine.wrap(HUBYBP_fake_script)()
local function ICWFEA_fake_script() -- Name.LocalScript 
...
coroutine.wrap(ICWFEA_fake_script)()
local function DFGV_fake_script() -- Name.ToogleScript 
	local script = Instance.new('LocalScript', Name)
...
coroutine.wrap(DFGV_fake_script)()
local function SLRLMNP_fake_script() -- Lines.LocalScript 
...
coroutine.wrap(SLRLMNP_fake_script)()
local function LDUQ_fake_script() -- Lines.ToogleScript 
	local script = Instance.new('LocalScript', Lines)
...
coroutine.wrap(LDUQ_fake_script)()
local function TDKT_fake_script() -- Box.LocalScript 
...
coroutine.wrap(TDKT_fake_script)()
local function UDZPT_fake_script() -- Box.ToogleScript 
	local script = Instance.new('LocalScript', Box)
...
coroutine.wrap(UDZPT_fake_script)()
local function YWMTXK_fake_script() -- HeadESP.LocalScript 
...
coroutine.wrap(YWMTXK_fake_script)()
local function ZOBRJA_fake_script() -- HeadESP.ToogleScript 
	local script = Instance.new('LocalScript', HeadESP)
...
coroutine.wrap(ZOBRJA_fake_script)()
local function AYAFBJ_fake_script() -- Aimbot.LocalScript 
...
coroutine.wrap(AYAFBJ_fake_script)()
local function CYQST_fake_script() -- TeamCheck.ToogleScript 
...
coroutine.wrap(CYQST_fake_script)()
local function MLRVZWX_fake_script() -- TriggerBot.ToogleScript 
...
coroutine.wrap(MLRVZWX_fake_script)()
local function WRBJ_fake_script() -- WallCheck.ToogleScript 
...
coroutine.wrap(WRBJ_fake_script)()
local function LRGUXHL_fake_script() -- Fov.ToogleScript 
...
coroutine.wrap(LRGUXHL_fake_script)()
local function YKFDAN_fake_script() -- Slider.LocalScript 
...
coroutine.wrap(YKFDAN_fake_script)()
local function ZFHGGH_fake_script() -- FovColour.ToogleScript 
...
coroutine.wrap(ZFHGGH_fake_script)()
local function NKUK_fake_script() -- Safe.LocalScript 
...
coroutine.wrap(NKUK_fake_script)()
local function KGYNPF_fake_script() -- Discord.LocalScript 
...
coroutine.wrap(KGYNPF_fake_script)()
local function KQIC_fake_script() -- Frame_2.ColourWheelHandler 
...
coroutine.wrap(KQIC_fake_script)()
local function NXVF_fake_script() -- Abrir.LocalScript 
...
coroutine.wrap(NXVF_fake_script)()
local function TSIYYZ_fake_script() -- Main.LocalScript 
...
coroutine.wrap(TSIYYZ_fake_script)()
local function ACDKVN_fake_script() -- Main.Notificacao 
	local script = Instance.new('LocalScript', Main)
...
coroutine.wrap(ACDKVN_fake_script)()
